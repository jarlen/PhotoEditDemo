...
import com.js.photosdk.crop.CropImageType.REVERSE_TYPE;
...
public class CropImageView extends FrameLayout {
   ...
   */
     ...
     */
    public void reverseImage(REVERSE_TYPE type)
    {
    	Matrix matrix = new Matrix();
    	
    	if(type == REVERSE_TYPE.UP_DOWN)
    	{
    		matrix.postScale(1, -1);//上下翻转
    	}
    	else if(type == REVERSE_TYPE.LEFT_RIGHT)
    	{
